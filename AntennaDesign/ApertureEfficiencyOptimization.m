...
%---test various geometries by modifying the following line---%
[theta0_deg, f_over_d, f_m, d_m] = BasicAntennaGeometry('theta0_deg', 46.1); %θ₀ is given so f/d is derived from it
