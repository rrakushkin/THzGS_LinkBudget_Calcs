...
%
% https://www.mathworks.com/matlabcentral/fileexchange/66464-gridlegend
%
% INPUTS
%
% --- Required ---
...
%   h2 = plot(x, [y3 y4], 'LineStyle', '--');
%   set(gca,'ColorOrderIndex',1)
%   h3 = plot(x, [y5 y6], 'LineStyle', ':');
%   h  = [h1 h2 h3];
%   rows = {'r1', 'r2', 'r3'};
%   cols = {'c1', 'c2'};
%   gridlegend(h', cols, rows, 'Interpreter', 'latex', 'Location', 'SouthEast'); 
%
...
% Reset current axes
% NOTE: This positions legend behind axes with plot
axes(curr_axes);
